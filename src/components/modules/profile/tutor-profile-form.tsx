    ...
    <DashboardPageShell maxWidth="narrow">
      <div className="space-y-8">
        <DashboardHero
          ...
          title="Tutor profile"
          description="This is what students see before they book—headline, rate, experience, and a friendly photo go a long way."
        />
        ...
        <Card className="border border-[#e4e1d8] bg-white shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Headline, bio, rate, experience, education, languages, and photo.
            </CardDescription>
          </CardHeader>
          <CardContent>
